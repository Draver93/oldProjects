...
{
	const D3DXVECTOR3* p = new D3DXVECTOR3(pos_x, pos_y, pos_z);
	const D3DXVECTOR3* l = new D3DXVECTOR3(look_x, look_y, look_z);
	const D3DXVECTOR3* n = new D3DXVECTOR3(0, 1, 0);
	mouse_control(keyboard_state);
	D3DXMatrixLookAtLH(&matrix_view, 	p,
																		l,
																		n);
